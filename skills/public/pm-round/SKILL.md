...
- **Dataset grounding**: When proposing app-specific work, read `challenge/GOOD_SG.json`, reference the exact idea ID and title, and keep the scope aligned with the dataset’s POC constraints.
