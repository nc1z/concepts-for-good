          ...
          {attrOpen && (
            <div className="topbar__attr-popover" role="dialog" aria-label="Attributions">
              ...
              <ul className="topbar__attr-list">
                <li>
                  <a href="https://www.linkedin.com/in/neil-c" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="#0A66C2" aria-hidden="true" style={{display:"inline",verticalAlign:"middle",marginRight:"4px"}}>
