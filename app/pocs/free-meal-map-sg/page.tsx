...
import { filterOptions, places } from "./data";
...
const checklistTemplate = [
  ...
  "Save this stop to revisit",
  "Share the address with someone nearby",
];
...
export default function FreeMealMapPage() {
  ...
  }, [checklistByPlace, filter, hydrated, notesByPlace, savedPlaceIds, search, selectedPlaceId]);
    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        <div>
          ...
          <h1>Find food support near you.</h1>
        </div>
      ...
      <section className={styles.controls}>
        <div className={styles.searchRow}>
          <input
            ...
            placeholder="Search by area or kind"
        ...
        <div className={styles.mapCanvas}>
          ...
          >
            <path
              ...
              pathLength="1"
            />
            <path d="M587 285c40 8 92 40 142 70" pathLength="1" />
          </svg>
          ...
          {filteredPlaces.map((place) => (
            <button
              ...
              } ${place.tags.includes("Refill needed") ? styles.hotspotAlert : ""}`}
            ...
            <div className={styles.notesCol}>
              ...
              <div className={styles.noteComposer}>
                <textarea
                  ...
                  placeholder="Hours, what was available, or a reminder to return"
                />
              ...
              <div className={styles.notesFeed}>
                {notes.length ? (
                  ...
                  <p className={styles.emptyState}>
                    Add a note about this stop — hours, what was available, or when to return.
                  </p>
                )}
              </div>
            </div>
